...
Having used Context before this lesson was fun and not overly difficult, but the
thing that stuck with me was the tidbit on using composition vs. context when
trying to avoid prop-drilling. The video from Michael Jackson that was shared
was also great in reinforcing that and showing how composition significantly
simplifies things.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=03%3A%20useContext%3A%20simple%20Counter&em=mkimek15%40gmail.com).
