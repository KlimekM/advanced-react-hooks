...
This lesson was helpful in cementing that we should use useEffect almost all of the time, and use useLayoutEffect when we are manipulating the DOM and a side effect will run that is noticable to the user.
## Background
